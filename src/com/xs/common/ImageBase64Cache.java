...
public class ImageBase64Cache {
	...
	private static ImageBase64Cache iamgeBase64Cash;
	
	private ImageBase64Cache(){}
	
	private static String path;
	
	public static ImageBase64Cache getInstance(){
		
		if(iamgeBase64Cash==null){
			iamgeBase64Cash=new ImageBase64Cache();
	...
	public  void cacheIamge(byte[] res, String id) throws IOException {
	...
	public String getCacheIamge(String id){
